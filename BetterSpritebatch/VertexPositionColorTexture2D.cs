...
public struct VertexPositionColorTexture2D(Vector2 position, Color color, Vector2 textureCoord) : IVertexType
{
    ...
    private static readonly VertexDeclaration _vertexDeclaration = new VertexDeclaration(
        ...
        new VertexElement(Unsafe.SizeOf<Vector2>(), VertexElementFormat.Color, VertexElementUsage.Color, 0),
        new VertexElement(Unsafe.SizeOf<Vector2>() + Unsafe.SizeOf<Color>(), VertexElementFormat.Vector2, VertexElementUsage.TextureCoordinate, 0)
        );
}
